...
public:
	void CreateMDF4(LPCTSTR strToolName, LPCTSTR strToolVendor, LPCTSTR strToolVersion, LPCTSTR strComment, long lVersion)
	{
		...
		InvokeHelper(0x1, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, strToolName, strToolVendor, strToolVersion, strComment, lVersion);
	}
	...
	void AddGroup(LPCTSTR strComment, long ExpNValues, long * iNo)
	{
		...
		InvokeHelper(0x3, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, strComment, ExpNValues, iNo);
	}
	void AddGroup64(LPCTSTR strComment, __int64 ExpNValues, long * iNo)
	{
		static BYTE parms[] = VTS_BSTR VTS_I8 VTS_PI4;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, strComment, ExpNValues, iNo);
	}
	void AddSignal(long iGroupNo, LPCTSTR strName, LPCTSTR strLabel, long lDataType, long lnFirstBit, long lnBits, LPCTSTR strUnit, double yFactor, double yOffset, long bHasNovalues, double Novalue, long invalPos, long * iNo)
	{
		...
		InvokeHelper(0x5, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, strName, strLabel, lDataType, lnFirstBit, lnBits, strUnit, yFactor, yOffset, bHasNovalues, Novalue, invalPos, iNo);
	}
	void AddTimeInfo(long iGroupNo, LPCTSTR strName, LPCTSTR strUnit, double Factor, double Offset)
	{
		...
		InvokeHelper(0x6, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, strName, strUnit, Factor, Offset);
	}
	void AddTimeSignal(long iGroupNo, LPCTSTR strName, long lDataType, long lnFirstBit, long lnBits, LPCTSTR strUnit, double Factor, double Offset, long * iNo)
	{
		...
		InvokeHelper(0x7, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, strName, lDataType, lnFirstBit, lnBits, strUnit, Factor, Offset, iNo);
	}
	void MakeGroups()
	{
	...
	void SetSignalValue(long iGroupNo, long iSignalNo, double Value, long bIsNovalue)
	{
		...
		InvokeHelper(0x9, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, iSignalNo, Value, bIsNovalue);
	}
	void WriteRecord(long iGroupNo)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xa, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo);
	}
	void FlushGroup(long iGroupNo)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xb, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo);
	}
	void Close()
	{
	...
	void CreateSRBlock(long lGroupNo, double dt, double xrange, double OldXFactor, double OldXOffset)
	{
		...
		InvokeHelper(0xd, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, lGroupNo, dt, xrange, OldXFactor, OldXOffset);
	}
	void SetFileTime(__int64 FileTime)
	{
		static BYTE parms[] = VTS_I8;
		InvokeHelper(0xe, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileTime);
	}
	void CopyGroup(unsigned __int64 ulMDF4File, long lGroupNo, __int64 iTimeDiff)
	{
		static BYTE parms[] = VTS_UI8 VTS_I4 VTS_I8;
		InvokeHelper(0xf, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ulMDF4File, lGroupNo, iTimeDiff);
	}
	void GroupDescription(long iGroupNo, LPCTSTR strAcqName, LPCTSTR strCGComment, LPCTSTR strSIName, LPCTSTR strSIPath, LPCTSTR strSIComment)
	{
		...
		InvokeHelper(0x10, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, strAcqName, strCGComment, strSIName, strSIPath, strSIComment);
	}
	void SignalDescription(long iGroupNo, long iSignalNo, LPCTSTR strSIName, LPCTSTR strSIPath, LPCTSTR strSIComment)
	{
		...
		InvokeHelper(0x11, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, iSignalNo, strSIName, strSIPath, strSIComment);
	}
	...
	void SetRecord(long lGroupNo, unsigned char * pBuffer)
	{
		...
		InvokeHelper(0x13, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, lGroupNo, pBuffer);
	}
	void SetMinMax(long iGroupNo, long iSignalNo, double Min, double Max)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_R8 VTS_R8;
		InvokeHelper(0x14, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, iSignalNo, Min, Max);
	}
	...
	void FileDescription(LPCTSTR strHDComment, long lTimerQualityClass, __int64 start_time_ns, unsigned short tz_offset_min, unsigned short dst_offset_min, unsigned char time_flags)
	{
		...
		InvokeHelper(0x16, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, strHDComment, lTimerQualityClass, start_time_ns, tz_offset_min, dst_offset_min, time_flags);
	}
	void SetSignalDiscrete(long iGroupNo, long iSignalNo, long bDiscrete, LPCTSTR strN2T)
	{
		...
		InvokeHelper(0x17, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, iSignalNo, bDiscrete, strN2T);
	}
	void SetTimeStat(long iGroupNo, double xMean, double xMin, double xMax, double xMinDelta, double xMaxDelta)
	{
		static BYTE parms[] = VTS_I4 VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_R8;
		InvokeHelper(0x18, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, xMean, xMin, xMax, xMinDelta, xMaxDelta);
	}
	void SetRecordValues(long iGroupNo, double * pValues, long nRecords)
	{
		static BYTE parms[] = VTS_I4 VTS_PR8 VTS_I4;
		InvokeHelper(0x19, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iGroupNo, pValues, nRecords);
	}
	void CreateSRBlocks()
	{
	...
	void SetFileTimeFraction(double FileTimeFraction)
	{
		...
		InvokeHelper(0x1b, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileTimeFraction);
	}
	void SetNanoTimeUTC(__int64 iNanoTimeUTC)
	{
		static BYTE parms[] = VTS_I8;
		InvokeHelper(0x1c, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, iNanoTimeUTC);
	}
